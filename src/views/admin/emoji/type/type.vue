<template>
  <div>
    ...
    <MFormDialog
      ...
      v-bind="formDialog"
      :fields="dialogFields"
      :httpAdd="emojiTypeAdd"
      :httpEdit="emojiTypeEdit"
      :httpGet="emojiTypeDetails"
      @reload="reload"
    ></MFormDialog>
  </div>
</template>
...
const del = (id: number) => {
  emojiTypeDel(id).then(clearSelectKeysReload)
}
</script>
